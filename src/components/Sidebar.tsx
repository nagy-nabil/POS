...
const Sidebar = () => {
   ...
   <aside className="h-screen bg-slate-800 dark:bg-gray-900" aria-label="Sidebar">
         ...
         <ul className="space-y-2">
            ...
            <li>
               <Link to={'/sign-in'} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  sign in
               </Link>
            </li>
         </ul>
